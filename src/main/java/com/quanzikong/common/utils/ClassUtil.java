...
public class ClassUtil {
     ...
     *
     *  Integer[][].class.getName() = "[[Ljava.lang.Integer;" ClassUtil.getClassName(Integer[][].class) =
     * "java.lang.Integer[][]"
     * </pre>
     *
     * </p>
     ...
     *
     * <pre>
     *  ClassUtil.getShortClassNameForObject(Boolean.TRUE) = "Boolean" ClassUtil.getShortClassNameForObject(new
     * Boolean[10]) = "Boolean[]" ClassUtil.getShortClassNameForObject(new int[1][2]) = "int[][]"
     * </pre>
     *
     * </p>
     *
     ...
     *
     * <pre>
     *  ClassUtil.getShortClassName(Boolean.class) = "Boolean" ClassUtil.getShortClassName(Boolean[].class) =
     * "Boolean[]" ClassUtil.getShortClassName(int[][].class) = "int[][]" ClassUtil.getShortClassName(Map.Entry.class) =
     * "Map.Entry"
     * </pre>
     *
     * </p>
     ...
     *
     * <pre>
     *  ClassUtil.getShortClassName(Boolean.class.getName()) = "Boolean" ClassUtil.getShortClassName(Boolean[].class
     *  .getName())
     * = "Boolean[]" ClassUtil.getShortClassName(int[][].class.getName()) = "int[][]"
     * ClassUtil.getShortClassName(Map.Entry.class.getName()) = "Map.Entry"
     * </pre>
     *
     * </p>
     *
        ...
        if (clazz.isPrimitive()) {
            ...
            if (Long.TYPE.equals(clazz)) {
                return Long.class.equals(fromClass) || Integer.TYPE.equals(fromClass) || Integer.class.equals(fromClass)
                    ...
                    || Short.class.equals(fromClass) || Character.TYPE.equals(fromClass) || Character.class.equals(
                    (fromClass));
            }
            ...
            if (Float.TYPE.equals(clazz)) {
                return Float.class.equals(fromClass) || Long.TYPE.equals(fromClass) || Long.class.equals(fromClass)
                    || Integer.TYPE.equals(fromClass) || Integer.class.equals(fromClass) || Byte.TYPE.equals(fromClass)
    ...
    private static String getClassName(String className, boolean processInnerClass) {
        ...
        switch (className.charAt(dimension)) {
            ...
            case 'L':
                char maoHao = ';';
                int two = 2;
                if ((className.charAt(length - 1) != maoHao) || (length <= (dimension + two))) {
                    // 非法类名
                    return className;
                }

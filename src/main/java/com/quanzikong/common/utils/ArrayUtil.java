...
public class ArrayUtil {
     ...
     * @throws IllegalArgumentException 如果有一个子数组元素个数小于2或不是<code>Map.Entry</code>实例
     */
    public static Map<Object, Object> toMap(Object[] array, Map map) {
        if (array == null) {
            return map;
        }
    ...
    public static String join(String[] array, String connector) {
        ...
        boolean ctorIsNotEmpty = (connector != null && connector.length() > 0);
        for (int i = 0; i < array.length; i++) {
            if (i == 0) {
                sb.append(array[i]);
            } else {
     ...
     * @return
     */
    public static String join(List<String> list, String connector) {
        if (CollectionUtil.isEmpty(list)) {
            return "";
        }
        return join(list.toArray(new String[0]), connector);
    }
     ...
     * @return
     */
    public static Object[] concat(Object[]... objArrays) {
     ...
     * @return
     */
    public static String[] unique(List<String> arr) {
        List<String> list = new LinkedList<String>();
        for (int i = 0; i < arr.size(); i++) {
            if (StringUtil.isBlank(arr.get(i))) {
                continue;
            }

            String tmpStr = arr.get(i).trim();
            if (!list.contains(tmpStr)) {
                list.add(tmpStr);
            }
        }
     ...
     * @return
     */
    public static String[] unique(String str, String separator) {
     ...
     * @return
     */
    public static List<String> asStrList(String... args) {
     ...
     * @return
     */
    public static Object getByDefVal(Object[] array, int idx, Object dVal) {
        try {
            return array[idx];
        } catch (Exception e) {
            return dVal;
